...
namespace Agrine {
	namespace Math {
		namespace Core {
			...
			/// <summary>
			/// Exception thrown when two mathematical objects have incompatible dimensions.
			/// </summary>
			public ref class DimensionMismatchException : MathException {
			public:
				DimensionMismatchException(String^ message) : MathException(message) {}
			};
